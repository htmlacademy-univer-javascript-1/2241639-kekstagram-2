...
const bigPictireImg = document.querySelector('.big-picture__img');
...
const descriptionUser = createDescriptionOfPhoto();
const socialCommentsCount = document.querySelector('.social__comment-count');
const commentsLoader = document.querySelector('.comments-loader');

//цикл для навешивания обработчика кликов и всавки рандомных данных
